...
let mostPets = pets > friendsPets ? 'My Pets ' + pets : 'Friends Pets ' + friendsPets;
...
switch (luckyNumber) {
    ...
    default : console.log('No luck for you!');
}

// 18 -- Rewrite question 13 with a `ternary` operator. You'll need to do research!

let goOut = adventurous ? 'Adventures are great!' : 'How about we stay home';
console.log(goOut);
